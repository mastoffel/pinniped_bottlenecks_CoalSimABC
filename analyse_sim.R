...
res_gfit_neut <- gfit(target=obs_stats, sumstat= sims_stats[models == "neut",], statistic=mean, nb.replicate=100)
...
# or PCA
gfitpca(target=obs_stats, sumstat=sims_stats, index=models, cprob=.01)
