...
all_seals_full <- sealABC::read_excel_sheets("../data/seal_data_largest_clust_and_pop.xlsx")[c(1, 9, 12, 15, 19)] #[1:28]
...
#               "exp_het_mean")   "exp_het_mean", "mean_allele_range"

# names(sims)
sumstats <- c("num_alleles_mean", "num_alleles_sd",
              "prop_low_afs_mean", "prop_low_afs_sd",
              "exp_het_mean", "mean_allele_size_sd")
...
sim_name <- "onepopprior_1mio_sims_gammaprior"
